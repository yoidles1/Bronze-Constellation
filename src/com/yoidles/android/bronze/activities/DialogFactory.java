...
import com.yoidles.android.bronze.R.id;
import com.yoidles.android.bronze.R.layout;
import com.yoidles.android.bronze.R.string;
import com.yoidles.android.bronze.kml.KmlException;
...
import com.yoidles.android.bronze.views.TimeTravelDialog;
import com.yoidles.android.bronze.views.EarthmarksDialog;
...
public class DialogFactory {
  ...
  static final int DIALOG_ID_DEBUG_MESSAGE = 8;
  static final int DIALOG_ID_EARTHMARKS = 9;
  ...
  public Dialog onCreateDialog(int id) {
    switch (id) {
      ...
      case (DialogFactory.DIALOG_ID_EARTHMARKS):
          return createEarthmarksDialog();
  ...
  private Dialog createHelpDialog() {
    ...
    String versionCode = ((BronzeConstellationApplication) parentActivity.getApplication()).getVersionName();
  ...
  */
   ...
   * Creates the time travel dialog.
   */
  private Dialog createEarthmarksDialog() {
    Log.d(TAG, "Creating earthmarks dialog.");
    EarthmarksDialog earthmarksDialog = new EarthmarksDialog(parentActivity,
        parentActivity.getModel());
    return earthmarksDialog;
  }
        ...
        .setPositiveButton(R.string.load_kml_file,
            new DialogInterface.OnClickListener() {
              public void onClick(DialogInterface dialog, int whichButton) {
                ...
                BronzeConstellationApplication.runInBackground(new Runnable() {
                  public void run() {
                    try {
                      String kmlUrl =
