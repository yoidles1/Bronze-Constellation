...
package com.yoidles.android.bronze.control;

import static com.yoidles.android.bronze.util.Geometry.addVectors;
import static com.yoidles.android.bronze.util.Geometry.calculateRADecOfZenith;
import static com.yoidles.android.bronze.util.Geometry.matrixMultiply;
import static com.yoidles.android.bronze.util.Geometry.matrixVectorMultiply;
import static com.yoidles.android.bronze.util.Geometry.scalarProduct;
import static com.yoidles.android.bronze.util.Geometry.scaleVector;
import static com.yoidles.android.bronze.util.Geometry.vectorProduct;
...
import com.yoidles.android.bronze.ApplicationConstants;
...
import com.yoidles.android.bronze.units.LatLong;
import com.yoidles.android.bronze.units.Matrix33;
import com.yoidles.android.bronze.units.RaDec;
import com.yoidles.android.bronze.units.Vector3;
import com.yoidles.android.bronze.util.Geometry;
...
public class AstronomerModelImpl implements AstronomerModel {
  ...
  @Override
// TODO RLP Here is where we set the earthmarks locations once we know how to set up the menus
  ...
  public void setLocation(LatLong location) {
    ...
    Log.d(TAG, "Setting location to " + location.toString());
...
public ArrayList<TextSource> getEarthMarkTextSources() { 
    return earthMarkTextSources;
}
  
public void setEarthMarkTextSources(ArrayList<TextSource> earthMarkTextSources) { 
    this.earthMarkTextSources = earthMarkTextSources; 
}
  
public ArrayList<PointSource> getEarthMarkPointSources() { 
...
public void setEarthMarks(ArrayList<EarthMark> earthMarks) {
	this.earthMarks = earthMarks;
}

public String getEarthMarkViewpointName() {
	return earthmarkViewpointName;
}

public void setEarthMarkViewpointName(String earthmarkViewpointName) {
	this.earthmarkViewpointName = earthmarkViewpointName;
}
...
public void setMarkNames(ArrayList<String> markNames) {
