...
public interface AstronomerModel {
  ...
  ArrayList<TextSource> getEarthMarkTextSources();  
  
  void setEarthMarkTextSources(ArrayList<TextSource> earthMarkTextSources);

  ArrayList<PointSource> getEarthMarkPointSources();
  
  void setEarthMarkPointSources(ArrayList<PointSource> earthMarkPointSources);
  ...
  public void setEarthMarkViewpointName(String earthMarks);
