...
//	Vector3 diff = Geometry.addVectors(toGeo, minusFromGeo);
	Vector3 diff = Geometry.addVectors(toGeo,  Geometry.scaleVector(minusFromGeo,(float) -0.7)); //Should put the viewport outside the earth 2x diameter opposite of the North West hemisphere
	diff.normalize();
