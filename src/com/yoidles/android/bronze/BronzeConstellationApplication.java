...
import com.yoidles.android.bronze.activities.DynamicStarMapActivity;
import com.yoidles.android.bronze.control.AstronomerModelImpl;
import com.yoidles.android.bronze.control.ZeroMagneticDeclinationCalculator;
import com.yoidles.android.bronze.layers.EclipticLayer;
import com.yoidles.android.bronze.layers.GridLayer;
import com.yoidles.android.bronze.layers.HorizonLayer;
import com.yoidles.android.bronze.layers.LayerManager;
import com.yoidles.android.bronze.layers.MeteorShowerLayer;
import com.yoidles.android.bronze.layers.NewConstellationsLayer;
import com.yoidles.android.bronze.layers.NewMessierLayer;
import com.yoidles.android.bronze.layers.NewStarsLayer;
import com.yoidles.android.bronze.layers.EarthLayer;
import com.yoidles.android.bronze.layers.PlanetsLayer;
import com.yoidles.android.bronze.layers.SkyGradientLayer;
import com.yoidles.android.bronze.util.Analytics;
import com.yoidles.android.bronze.util.Analytics.Slice;
import com.yoidles.android.bronze.util.MiscUtil;
import com.yoidles.android.bronze.util.OsVersions;
import com.yoidles.android.bronze.util.PreferenceChangeAnalyticsTracker;
 ...
 *
 * @author John Taylor (modified by RLP)
 */
public class BronzeConstellationApplication extends Application {
  private static final String TAG = MiscUtil.getTag(BronzeConstellationApplication.class);
  ...
  private static AstronomerModelImpl model;
  ...
  public void onCreate() {
    ...
    Log.d(TAG, "BronzeConstellationApplication: -onCreate");
  }
  ...
  public static synchronized LayerManager getLayerManager(AssetManager assetManager,
      ...
      layerManager.addLayer(new EarthLayer(getModel(), assetManager, resources));
   ...
   * Return the model.
   */
  public static synchronized AstronomerModelImpl getModel() {
    if (model == null) {
