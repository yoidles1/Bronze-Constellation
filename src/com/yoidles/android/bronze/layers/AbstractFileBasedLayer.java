...
import com.yoidles.android.bronze.base.Closeables;
import com.yoidles.android.bronze.renderer.RendererObjectManager.UpdateType;
import com.yoidles.android.bronze.source.AstronomicalSource;
import com.yoidles.android.bronze.source.proto.ProtobufAstronomicalSource;
import com.yoidles.android.bronze.source.proto.SourceProto.AstronomicalSourceProto;
import com.yoidles.android.bronze.source.proto.SourceProto.AstronomicalSourcesProto;
import com.yoidles.android.bronze.util.Blog;
import com.yoidles.android.bronze.util.MiscUtil;
import com.yoidles.android.bronze.util.StopWatch;
import com.yoidles.android.bronze.util.StopWatchImpl;
...
public abstract class AbstractFileBasedLayer extends AbstractSourceLayer {
  ...
  public AbstractFileBasedLayer(AssetManager assetManager, Resources resources, String fileName, boolean shouldUpdate) {
